  ...
  const architecturalPillars = [
    {
      id: 'pillar-video',
      tag: 'PDF OCR Engine',
      title: 'SEC & Financial Document Parser',
      description: 'High-density extraction of financial covenants, balance sheet items, and proprietary M&A pitch decks under 24ms with 100% OCR precision.',
    },
    {
      id: 'pillar-iap',
      tag: 'NIST AI RMF',
      title: 'Confidential PII Anonymizer',
      description: 'Inline compliance gateway that intercepts sensitive banker data, scrubs PII, and tokenizes confidential email/phone fields before LLM exposure.',
    },
    {
      id: 'pillar-ai',
      tag: 'Dual LLM Gateway',
      title: 'Zero-Downtime Model Routing',
      description: 'OpenAI gpt-4o-mini with instant 1500ms circuit breaker failover to Claude Sonnet and 4-bit localized LoRA private cloud containers.',
    },
  ];
          ...
          <div className="rounded-xl border border-[var(--color-border)] bg-[var(--color-surface)] overflow-hidden shadow-2xs hover:shadow-xs transition-shadow mb-8">
            <div className="relative h-64 sm:h-80 w-full overflow-hidden bg-slate-900">
              ...
              <img
                ...
                alt="High-performance investment banking AI analytics dashboard"
            ...
            <div className="p-6 sm:p-8 flex flex-col sm:flex-row sm:items-center justify-between gap-6">
              <div className="space-y-1 max-w-2xl">
                ...
                <p className="text-xs sm:text-sm text-[var(--color-text-secondary)] opacity-85 leading-relaxed">
                  Eliminated confidential data leaks and third-party risks through inline NIST AI RMF prompt firewalls and localized secure private cloud container fallbacks.
                </p>
              </div>
