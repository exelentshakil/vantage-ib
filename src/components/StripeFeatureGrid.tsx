...
const FEATURES: FeatureItem[] = [
  ...
  },
  {
    ...
    description: 'Receive ongoing operational monitoring, Inngest background event queues, automated dual-model routing failover, and strict 99.999% SLA response tracking.',
